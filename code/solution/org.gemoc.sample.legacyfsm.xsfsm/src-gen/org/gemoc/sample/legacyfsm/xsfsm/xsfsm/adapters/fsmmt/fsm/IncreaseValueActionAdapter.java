...
public class IncreaseValueActionAdapter extends EObjectAdapter<IncreaseValueAction> implements org.gemoc.sample.legacyfsm.fsm.IncreaseValueAction {
  private FSMMTAdaptersFactory adaptersFactory;
  
  public IncreaseValueActionAdapter() {
  ...
  public EClass eClass() {
    return org.gemoc.sample.legacyfsm.fsm.FsmPackage.eINSTANCE.getIncreaseValueAction();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.sample.legacyfsm.fsm.FsmPackage.INCREASE_VALUE_ACTION__TARGET:
    		return getTarget();
    	case org.gemoc.sample.legacyfsm.fsm.FsmPackage.INCREASE_VALUE_ACTION__STEP_VALUE:
