...
public class DecreaseValueActionAspect extends ActionAspect {
  ...
  public static void execute(final DecreaseValueAction _self) {
	final org.gemoc.sample.legacyfsm.xsfsm.xsfsm.aspects.DecreaseValueActionAspectDecreaseValueActionAspectProperties _self_ = org.gemoc.sample.legacyfsm.xsfsm.xsfsm.aspects.DecreaseValueActionAspectDecreaseValueActionAspectContext
			.getSelf(_self);
	...
	if (manager != null) {
		manager.executeStep(_self, command, "DecreaseValueAction", "execute");
	} else {
  ...
  protected static void _privk3_execute(final DecreaseValueActionAspectDecreaseValueActionAspectProperties _self_, final DecreaseValueAction _self) {
    ...
    Long _value = NumberVariableAspect.value(target);
    long _stepValue = _self.getStepValue();
    long _minus = ((_value).longValue() - _stepValue);
    NumberVariableAspect.value(target, Long.valueOf(_minus));
  }
}
