...
public class AssignValueActionAspect extends ActionAspect {
  ...
  public static void execute(final AssignValueAction _self) {
    final org.gemoc.sample.legacyfsm.fsm.k3dsa.AssignValueActionAspectAssignValueActionAspectProperties _self_ = org.gemoc.sample.legacyfsm.fsm.k3dsa.AssignValueActionAspectAssignValueActionAspectContext.getSelf(_self);
     if (_self instanceof org.gemoc.sample.legacyfsm.fsm.AssignValueAction){
    					fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand command = new fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand() {
    						@Override
    						public void execute() {
    							org.gemoc.sample.legacyfsm.fsm.k3dsa.AssignValueActionAspect._privk3_execute(_self_, (org.gemoc.sample.legacyfsm.fsm.AssignValueAction)_self);
    						}
    					};
    					fr.inria.diverse.k3.al.annotationprocessor.stepmanager.IStepManager stepManager = fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepManagerRegistry.getInstance().findStepManager(_self);
    					if (stepManager != null) {
    						stepManager.executeStep(_self,command,"AssignValueAction","execute");
    					} else {
