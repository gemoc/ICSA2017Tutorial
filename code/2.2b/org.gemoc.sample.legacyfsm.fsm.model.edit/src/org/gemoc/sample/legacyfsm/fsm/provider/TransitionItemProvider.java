...
/**
 * This is the item provider adapter for a {@link org.gemoc.sample.legacyfsm.fsm.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FsmPackage.Literals.TRANSITION__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		newChildDescriptors.add
			(createChildParameter
				(FsmPackage.Literals.TRANSITION__ACTION,
				 FsmFactory.eINSTANCE.createNumberAction()));
	}
